// Shared links + identifiers used across the site (header, footer, pages).
export const CLOUD_URL = 'https://cloud.tessio.eu';
export const API_URL = 'https://api.tessio.eu';
export const VERIFIER_URL = 'https://verifier.tessio.eu';
...
export const ACCESS_MAILTO = `mailto:${CONTACT_EMAIL}?subject=Tessio.Cloud%20access`;
